...
with mp_hands.Hands(
    ...
    while cap.isOpened():
        ...
        if len(co) == 2:
            ...
            cv2.circle(img=image, center=(int(xm), int(ym)), radius=radius, color=(0, 0, 0), thickness=25)
            cv2.circle(img=image, center=(int(xm), int(ym)), radius=70, color=(200, 170, 30), thickness=15)
            cv2.circle(img=image, center=(int(xm), int(ym)), radius=60, color=(0, 0, 0), thickness=15)
            cv2.circle(img=image, center=(int(xm), int(ym)), radius=150, color=(0, 0, 0), thickness=10)
            cv2.circle(img=image, center=(int(xm), int(ym)), radius=140, color=(0, 0, 255), thickness=10)
            cv2.circle(img=image, center=(int(xm), int(ym)), radius=130, color=(0, 0, 0), thickness=10)

            l = (int(math.sqrt((co[0][0] - co[1][0]) ** 2 * (co[0][1] - co[1][1]) ** 2)) - 150) // 2
            cv2.line(image, (int(xa), int(ya)), (int(xb), int(yb)), (0, 0, 0), 13)
            if co[0][0] > co[1][0] and co[0][1] > co[1][1] and co[0][1] - co[1][1] > 65:
                print("→")
                keyinput.release_key('s')
                keyinput.release_key('d')
                keyinput.press_key('a')
                cv2.putText(image, "", (50, 50), font, 0.8, (0, 0, 255), 2, cv2.LINE_AA)
                cv2.line(image, (int(xbp), int(ybp)), (int(xm), int(ym)), (0, 255, 0), 10)
                ...
                cv2.putText(image, "", (50, 50), font, 0.8, (0, 0, 255), 2, cv2.LINE_AA)
                cv2.line(image, (int(xap), int(yap)), (int(xm), int(ym)), (0, 255, 0), 10)
                ...
                cv2.line(image, (int(xap), int(yap)), (int(xm), int(ym)), (255, 0, 0), 10)
                ...
                if ybp > yap:
                    ...
                    cv2.line(image, (int(xap), int(yap)), (int(xm), int(ym)), (0, 0, 255), 10)
        ...
        if len(co) == 1:
            ...
            cv2.putText(image, "", (50, 50), font, 1.0, (0, 0, 255), 2, cv2.LINE_AA)
